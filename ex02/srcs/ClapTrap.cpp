...
/*   Updated: 2024/11/19 14:10:24 by debian           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default constructor (std::string name, int hitPoints, int energyPoints, int attackDamage) of ClapTrap " << name << " called" << std::endl;
	return ;
}
